...
namespace Persistence.Migrations
{
    ...
    [Migration("20240326193223_InitialCreate")]
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ebfbe81f-1550-47f9-85dd-4e3714b9d7f6"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(2024, 3, 26, 22, 32, 22, 711, DateTimeKind.Local).AddTicks(4577),
                            DateOfBirth = new DateTime(2024, 3, 26, 22, 32, 22, 711, DateTimeKind.Local).AddTicks(4553),
                            Email = "narch@kodlama.io",
                            FirstName = "Eylem",
                            LastName = "Sayın",
                            NationalIdentity = "123456",
                            PasswordHash = new byte[] { 40, 69, 180, 182, 122, 32, 61, 123, 22, 234, 208, 84, 124, 136, 179, 172, 163, 193, 65, 95, 103, 160, 79, 118, 245, 199, 142, 88, 90, 64, 167, 255, 42, 46, 45, 166, 230, 64, 28, 38, 193, 161, 141, 168, 82, 195, 249, 84, 112, 28, 241, 213, 247, 248, 94, 128, 240, 113, 251, 131, 232, 193, 68, 150 },
                            PasswordSalt = new byte[] { 218, 50, 70, 51, 139, 244, 220, 30, 156, 91, 234, 34, 110, 247, 198, 250, 220, 241, 245, 155, 104, 9, 88, 107, 246, 203, 202, 133, 237, 24, 31, 167, 52, 15, 83, 53, 218, 155, 73, 151, 133, 168, 247, 191, 75, 208, 157, 196, 211, 66, 253, 121, 159, 17, 81, 143, 165, 133, 33, 150, 188, 225, 133, 126, 4, 44, 222, 232, 18, 197, 133, 20, 119, 50, 251, 9, 120, 158, 151, 105, 97, 39, 152, 79, 196, 116, 140, 80, 209, 209, 250, 237, 63, 31, 105, 179, 137, 237, 126, 32, 112, 152, 93, 34, 7, 53, 77, 90, 64, 163, 61, 161, 54, 115, 142, 177, 43, 194, 244, 96, 143, 31, 249, 154, 235, 187, 125, 224 },
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("719d53c1-83bb-43be-a3ac-f015c95c9e36"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("ebfbe81f-1550-47f9-85dd-4e3714b9d7f6")
                        });
                });
